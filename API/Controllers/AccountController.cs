...
public class AccountController : ControllerBase // Controller is for MVC
{
    ...
    public IActionResult ForgotPassword(ForgotPasswordDto forgotPasswordDto)
    {
        try
        {
            ...
            _emailHandler.Send("Forgot Password", $"Your OTP is {otp}", forgotPasswordDto.Email); // Kirim email ke email yang diberikan
    ...
    public IActionResult ChangePassword(ChangePasswordDto changePasswordDto)
    {
        try
        {
            ...
            {
                return BadRequest(new ResponseValidatorHandler("OTP has not been used yet"));
            }
