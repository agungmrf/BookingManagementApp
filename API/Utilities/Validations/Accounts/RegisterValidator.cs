...
public class RegisterValidator : AbstractValidator<RegisterDto>
{
    public RegisterValidator()
    {
        ...
        RuleFor(e => e.Major)
            ...
            .MaximumLength(100).WithMessage("Major must not exceed 100 characters."); // Validasi agar Major tidak melebihi 100 karakter

        RuleFor(e => e.Degree)
            .NotEmpty() // Validasi agar Degree tidak kosong
            .MaximumLength(100).WithMessage("Degree must not exceed 100 characters."); // Validasi agar Degree tidak melebihi 100 karakter
        ...
        RuleFor(e => e.Password)
            ...
            .WithMessage("Password must contain at least 8 characters, one uppercase, one lowercase, one number and one special case character");
